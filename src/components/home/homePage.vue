...
import lineChart from '@/assets/charts/lineChart.vue'
import columnChart from '@/assets/charts/columnChart.vue'
import areaChart from '@/assets/charts/areaChart.vue'
